...
# 88 "c:\\Users\\yamas\\Documents\\GitHub\\takataka_robo_soccer_2026\\Gunma\\本番\\new_maxon_diffence\\new_maxon_diffence.ino" 3
...
# 111 "c:\\Users\\yamas\\Documents\\GitHub\\takataka_robo_soccer_2026\\Gunma\\本番\\new_maxon_diffence\\new_maxon_diffence.ino" 3
                                   3.14159265358979323846 /* pi */ 
# 111 "c:\\Users\\yamas\\Documents\\GitHub\\takataka_robo_soccer_2026\\Gunma\\本番\\new_maxon_diffence\\new_maxon_diffence.ino"
                                        / 180.0;
  }
...
void MotorDrive(int face_angle, int speed_per, int gryo_val)
{
  ...
  face_rad = face_angle * 
# 150 "c:\\Users\\yamas\\Documents\\GitHub\\takataka_robo_soccer_2026\\Gunma\\本番\\new_maxon_diffence\\new_maxon_diffence.ino" 3
                         3.14159265358979323846 /* pi */ 
# 150 "c:\\Users\\yamas\\Documents\\GitHub\\takataka_robo_soccer_2026\\Gunma\\本番\\new_maxon_diffence\\new_maxon_diffence.ino"
                              / 180.0;
...
float get_line_x() {
  ...
  for (int i = 0; i < 32; i++) {
    if (line_check[i] == 1) {
       float rad = 11.25 * i * 3.1415926535897932384626433832795 / 180.0;
       temp_sum_x += cos(rad);
       sensor_count_x++;
    }
  }
...
void line_trace(float gryo_val){
  ...
  float l_x_curved = pow(((l_x_tmp)>0?(l_x_tmp):-(l_x_tmp)), line_power) * sign_l_x;

  // --- Y軸の計算 ---
  float l_y_tmp = get_line_y();
  int sign_l_y = 1;
  if (l_y_tmp < 0) sign_l_y = -1;
  float l_y_curved = pow(((l_y_tmp)>0?(l_y_tmp):-(l_y_tmp)), line_power) * sign_l_y;
  ...
  float ir_rad = ir_angle * 3.1415926535897932384626433832795 / 180.0;
  ...
  float move_angle = move_rad * 180.0 / 3.1415926535897932384626433832795; // float計算推奨

  float speed_coefficient = 30.0;
  float move_speed = sqrt(m_x * m_x + m_y * m_y) * speed_coefficient;
  move_speed = ((move_speed)<(0)?(0):((move_speed)>(100)?(100):(move_speed)));
